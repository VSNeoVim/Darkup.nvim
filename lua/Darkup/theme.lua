local colors = require('Darkup.colors')
local theme = {}

theme.load_syntax = function()
    local c = colors.generate()
    local isDark = vim.g.Darkup_style == 'dark'
    local isItalic = vim.g.Darkup_italic_comment == 1
    local no_nvimtree_bg = vim.g.Darkup_disable_nvimtree_bg == true
    local syntax = {
        ...
        Underlined = { c.vscBlue, nil, 'underline', nil },
